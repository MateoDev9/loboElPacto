...
export const ROLES: Record<RoleId, RoleDefinition> = {
  ...
  hunter: role({ id: 'hunter', name: 'Cazador', shortName: 'Cazador', icon: '🎯', color: '#7b805b', team: 'village', category: 'village', maxCards: 1, callKind: 'confirm', passive: true, description: 'Al morir, elimina inmediatamente a otra persona.', narratorPrompt: 'Ubica al Cazador. Cuando muera, la app abrirá su disparo antes de continuar.' }),
  ...
  rusty_knight: role({ id: 'rusty_knight', name: 'Caballero de la Espada Oxidada', shortName: 'Caballero', icon: '🗡️', color: '#7d7061', team: 'village', category: 'village', maxCards: 1, callKind: 'confirm', passive: true, description: 'Si es devorado, enferma al lobo vivo más cercano a su izquierda.', narratorPrompt: 'Ubícalo. Si los lobos lo devoran, la app señalará la muerte aplazada del lobo más cercano a su izquierda.' }),
  ...
  devoted_servant: role({ id: 'devoted_servant', name: 'Abnegada Sirvienta', shortName: 'Sirvienta', icon: '🫶', color: '#aa728d', team: 'variable', category: 'ambiguous', maxCards: 1, callKind: 'confirm', passive: true, description: 'Antes de revelar a un linchado puede adoptar su carta.', narratorPrompt: 'Ubícala. Antes de cada revelación por votación, la app preguntará si adopta el personaje eliminado.' }),
